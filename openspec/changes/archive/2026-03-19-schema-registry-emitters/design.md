...
Proven by introspection test on test app: 3 scaffolded resources (Parcel, District, Owner) — all attributes, types, permits, routes, DB columns extracted automatically from runtime.
